...
export class OrganizationsEffect {
  ...
  getOrganizationByKey$: CreateEffectMetadata = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap((action: { id: number }) =>
        this.organizationService.getOrganizationByKey(action.id)
      ),
  ...
  addOrganization$: CreateEffectMetadata = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap((action: { organization: CreateOrganization }) =>
        this.organizationService.addOrganization(action.organization)
      ),
      map((organization: Organization) =>
        postOrganizationSuccess(organization)
      ),
  ...
  updateOrganization$: CreateEffectMetadata = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap((action: CreateOrganization) =>
        this.organizationService.update(action)
      ),
      map((organization: Organization) =>
      ...
      this.actions$.pipe(
        ...
        tap(() => {
          this.toastService.addErrorMessage(
            ActionTypes.UpdateOrganizationError
          );
        })
      ),
    { dispatch: false }
  ...
  deleteOrganization$: CreateEffectMetadata = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap((action: { id: number }) =>
        this.organizationService.delete(action.id)
      ),
      map((organizations: Organization[]) =>
  ...
  deleteOrganizationError$: CreateEffectMetadata = createEffect(
    () =>
      this.actions$.pipe(
        ...
        tap(() => {
          this.toastService.addErrorMessage(
            ActionTypes.DeleteOrganizationError
          );
        })
      ),
    { dispatch: false }
