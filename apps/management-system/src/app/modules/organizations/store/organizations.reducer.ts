...
export const OrganizationsReducer: ActionReducer<OrganizationsState, Action> =
  createReducer(
    ...
    on(
      getOrganizationsSuccess,
      (state: OrganizationsState, { organizations }: PropsOrganizations) => ({
        ...state,
        organizations,
        pending: false,
      })
    ...
    on(
      postOrganizationSuccess,
      (state: OrganizationsState, organization: Organization) => {
        const newOrganizationsState: Organization[] = [
          ...state.organizations,
          organization,
        ];
        return {
          ...state,
          organizations: newOrganizationsState,
          pending: false,
        };
      }
    ),
    ...
    on(
      ...
      (state: OrganizationsState, organization: Organization) => {
        ...
        const newState: OrganizationsState = {
          ...state,
          organizations: newOrganizationsState,
          pending: false,
        };
